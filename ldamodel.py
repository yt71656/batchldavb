...
class LdaModel(interfaces.TransformationABC):
    ...
    def __init__(self, corpus=None, num_topics=100, id2word=None,
        ...
        if self.id2word is None:
            ...
            self.id2word = utils.dict_from_corpus(corpus)#该函数扫描所有单词的id，返回“wordid->str”的映射
        ...
        self.optimize_alpha = alpha == 'auto'#初始化alpha的三种形式
        ...
        self.state.sstats = numpy.random.gamma(100., 1. / 100., (self.num_topics, self.num_terms))#Draw samples from a Gamma distribution  gamma(shape, scale, size)
        self.sync_state()
